...
export const projects: Project[] = [
  {
    ...
    pagesUrl: 'https://alvinhhh.github.io/chess-chaos',
    status: 'active',
  },
  {
    title: 'pitch-ipsum',
    ...
    pagesUrl: 'https://alvinhhh.github.io/pitch-ipsum',
    status: 'active',
  },
  {
    title: 'not-hotdog',
    ...
    pagesUrl: 'https://alvinhhh.github.io/not-hotdog',
    status: 'active',
  },
  {
    ...
    pagesUrl: 'https://alvinhhh.github.io/tc-life-ruiner',
    status: 'active',
  },
  {
    ...
    pagesUrl: 'https://alvinhhh.github.io/vc-rejection-clicker',
    status: 'active',
  },
];
